...
--bg-glass-light: rgba(10, 10, 10, 0.7)
...
--border-pink: rgba(255, 0, 150, 0.3)
--border-purple: rgba(100, 100, 255, 0.2)
```
...
```css
--font-size-xxs: 11px;   /* Music time, small details */
--font-size-xs: 14px;    /* Labels, YouTube input */
--font-size-sm: 16px;    /* Buttons, body text */
--font-size-md: 18px;    /* Rep counter, settings */
--font-size-lg: 36px;    /* Headers (responsive) */
--font-size-xl: 80px;    /* Timer value display */
```
...
--font-weight-medium: 600;      /* Emphasized text */
--font-weight-bold: 700;        /* Buttons, labels */
--font-weight-extra-bold: 800;  /* Important actions */
--font-weight-black: 900;       /* Timer display */
```

### Letter Spacing

```css
--letter-spacing: 2px;         /* Standard spacing */
--letter-spacing-wide: 4px;    /* Headers, buttons */
```
...
filter: drop-shadow(0 4px 8px rgba(0, 255, 200, 0.3));
```
...
filter: drop-shadow(0 4px 8px rgba(255, 0, 150, 0.5));
```
...
--radius-md: 8px;    /* Inputs, progress bars */
--radius-lg: 10px;   /* Buttons, sections */
--radius-xl: 15px;   /* Cards, panels */
--radius-xxl: 20px;  /* Timer display */
```
...
```css
background: linear-gradient(135deg, #00ffc8, #6464ff);
color: #000;
font-weight: 800;
...
```css
background: linear-gradient(135deg, #ff0096, #6464ff);
color: #fff;
font-weight: 800;
```
